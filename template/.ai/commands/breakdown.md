...
type: command
name: breakdown
description: plan.mdからimplementation.mdを生成。実装計画を実行可能なタスクリストに変換
usage:
  - /breakdown
  - /breakdown work/plan.md
---
...
テンプレート: `.ai/references/templates/implementation.md`

## タスク分解のベストプラクティス

→ 詳細: `.ai/references/guides/task-breakdown.md`
